...
const ContactSection: React.FC = () => {
  return (
    <section id="contact" className="py-20 md:py-28 bg-gradient-to-br from-white to-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="backdrop-blur-md bg-white/50 p-8 rounded-xl border border-white/30 shadow-sm">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start backdrop-blur-sm bg-white/30 p-4 rounded-lg border border-white/20">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full backdrop-blur-sm bg-white/40 border border-white/30 flex items-center justify-center hover:bg-portfolio-accent hover:text-white transition-colors">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input 
                    ...
                    className="w-full bg-white/80 backdrop-blur-sm border-white/30"
                  />
                </div>
              ...
              <div>
                ...
                <Textarea 
                  ...
                  className="w-full h-32 bg-white/80 backdrop-blur-sm border-white/30"
                />
              </div>
              
              <Button className="w-full bg-portfolio-accent/90 backdrop-blur-sm hover:bg-portfolio-accent text-white btn-hover-effect">
